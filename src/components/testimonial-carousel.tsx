        ...
        <div className="overflow-hidden">
          {isClient && (
            <div 
              ...
              style={{
                width: `${testimonials.length * 450 * 2}px`, // Double the width for repeating items
              }}
            >
              {/* First set of cards */}
...
function TestimonialCard({ testimonial }: { testimonial: Testimonial }) {
  return (
    <div className="bg-black rounded-2xl p-6 min-w-[400px] max-w-[400px] flex flex-col relative 
                    ...
                    before:bg-gradient-to-r before:from-[#f87171] before:via-[#a855f7] before:to-[#3b82f6]
                    before:animate-gradientBorder before:-z-10">
      <div className="bg-black rounded-2xl h-full">
        ...
        <div className="flex items-center mt-4">
          <div>
            <div className="text-white font-mono font-semibold group-hover:text-blue-300 transition-colors">{testimonial.author}</div>
          </div>
        </div>
      </div>
    </div>
